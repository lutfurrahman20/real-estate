...
const Properties = () => {
  ...
  return (
    <div className={`${darkMode ? "dark bg-black" : "light bg-transparent"}`}>
      <section
        id="properties"
        className="lg:w-[90%] m-auto lg:px-20 px-6 py-28 w-full flex flex-col justify-center items-start gap-10"
      >
            ...
            >
              ...
              >
                <div id="top" className="flex justify-between items-end w-full">
                  <div>
                    <button className="px-3 py-3 bg-red-600 hover:bg-white hover:text-black text-white rounded-full text-[13px]">
                      Featured
                    </button>
                  </div>
              ...
              <div className="px-6 py-3 flex flex-col justify-center items-start gap-2 w-full">
                ...
                >
                  <div className="flex justify-center items-center gap-2">
                    <FaUserCircle className="size-5 text-red-500" />
